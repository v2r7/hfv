...
client.on("interactionCreate", async interaction => {
  ...
  let embed1 = new Discord.MessageEmbed() 
      .setColor("#e67e22") 
    .setThumbnail(`https://cdn.discordapp.com/attachments/1188885598484832437/1228545602724565103/IMG_8182.png?ex=662c6f40&is=6619fa40&hm=2412b87ba3a240a379ab1ad6028976891a9e2cea10aa2123015af602e044ffb9&`)
    	.setAuthor(` ${interaction.guild.name}`,interaction.guild.iconURL({dynamic:true}))     
